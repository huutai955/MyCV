...
function App() {
  ...
  return (
        ...
        <div className="container flex justify-between px-12  max-[768px]:flex-row-reverse">
          ...
          <ul className='flex gap-8 max-[768px]:hidden'>
            <Fade direction='down' delay={100}>
              <li className='font-normal cursor-pointer text-grey-custom hover:text-hover-color duration-700'><span>About</span></li>
            </Fade>
            <Fade direction='down'  delay={300}>
              <li className='font-normal cursor-pointer text-grey-custom hover:text-hover-color duration-700'><span>Work</span></li>
            </Fade>
            <Fade direction='down'  delay={500}>
              <li className='font-normal cursor-pointer text-grey-custom hover:text-hover-color duration-700'><span>Contact</span></li>
            </Fade>
    ...
    <div className="aboutme bg-dark-navy pb-24 px-24 max-[768px]:px-2">
        <div className="container max-[768px]:px-2">
        <Fade delay={1700}>
      ...
      <div className="myproject bg-dark-navy py-24  px-24 max-[992px]:p-0">
        <div className="container max-[680px]:px-3">
          ...
          <div className="project1 flex relative mb-40 items-center py-24">
            ...
            <div >
              ...
              <a href="" className='absolute top-0 right-0 left-0 bottom-0 opacity-70 hover:opacity-0 duration-700 max-[992px]:hidden' style={{ backgroundColor: '#1d4652' }}></a>
              {/* Mobile */}
      ...
      <div className="contact bg-dark-navy px-24 py-24 max-[768px]:px-2">
